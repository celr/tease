...
class ImageTool implements Tool extends BackgroundableTool {
    ...
    constructor(public id: string) {
        super(id, $('<img id="' + id + '" src = "Tease/res/default-image.png"></img>'));
        this.displayName = 'Image';
        this.displayImagePath = 'Tease/res/image-tool.png';

        this.properties['image-source'] = 'Tease/res/default-image.png';
